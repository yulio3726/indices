...
#ifndef SBEP3_SBEP3_H
#define SBEP3_SBEP3_H

typedef struct{

    Obj** tablaPermutantes; //arreglo de los permutantes
    char* descr; //nombre de la base de datos
    int n; //tamaño de la base de datos
    int b; //numero de bloques a utilizar, el tamaño del sketch es de 64 * el numero b
    int longBloque;
